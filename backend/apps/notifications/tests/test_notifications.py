...
from apps.notifications.services import archive_by_course, create_notification
...
class TestNotificationService(TestCase):
    @patch("apps.notifications.services._enqueue_email_mirror")
    ...
    def test_archive_by_course(self, mock_email):
        ...
        course = AcademicCourse(
            organization=ctx["org"], label="2024", is_active=False, status="ARCHIVED"
        )
        course.save()
