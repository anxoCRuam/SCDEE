...
class TestUserExport(TestCase):
    ...
    def test_export_csv(self):
        ...
        response = client.get("/api/v1/users/export/?export_format=csv")
    ...
    def test_export_json(self):
        ...
        response = client.get("/api/v1/users/export/?export_format=json")
    ...
    def test_export_with_filter(self):
        ...
        response = client.get("/api/v1/users/export/?export_format=json&is_active=true")
