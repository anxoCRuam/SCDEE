...
\begin{itemize}
  ...
  drf-spectacular (\cref{SEC:DES-API}); \texttt{graph\_models} fue
  usado para la generación de los diagramas de clase, función de
  django-extensions. Estos artefactos
