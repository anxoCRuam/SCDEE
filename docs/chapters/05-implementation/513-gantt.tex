...
veinticuatro semanas (\cref{fig:scdee-gantt}). Dos hitos vertebran el
calendario: la conclusión de la fase 0 (semana~2), que marca la
disponibilidad de la arquitectura base, y la conclusión de la fase 6
(semana~15), que marca el primer momento en que el sistema completa el
...
proyecto sino transversalmente desde la semana~17, lo que permite
endurecer el sistema de forma incremental a medida que las
funcionalidades se completan.
