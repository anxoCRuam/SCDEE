...
\title{Backend de Sistema de Corrección Digital de Exámenes Escritos} % TODO ¿Título OK?
\author{Anxo Canay Reguera}
\advisor{Eloy Anguiano Rey}
\levelin{Grado en Ingeniería Informática}
\copyrightdate{Mayo de 2026}
...
\ackfile{front-matter/acknowledgements}
...
% --- Metadatos del PDF --------------------------------------------------------
\pdfmetavalues% # TODO ¿metadatos? ¿que poner?
  {Anxo Canay Reguera}%
